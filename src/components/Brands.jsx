      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.row}>
          <View style={styles.brands}>
            <Image source={Brand1} style={styles.brandImg} />
            <Text style={styles.brandTitle}>
              Min. 20% off | Fossil, Titan Smart Watch & More
            </Text>
          </View>
          <View style={styles.brands}>
            <Image source={Brand2} style={styles.brandImg} />
            <Text style={styles.brandTitle}>
        ...
        <View style={styles.row}>
          <View style={styles.brands}>
            <Image source={Brand3} style={styles.brandImg} />
            <Text style={styles.brandTitle}>
              Heels - Upto 50% OFF on Heeled Sandals, High Heel
            </Text>
          </View>
          <View style={styles.brands}>
            <Image source={Brand4} style={styles.brandImg} />
            <Text style={styles.brandTitle}>
